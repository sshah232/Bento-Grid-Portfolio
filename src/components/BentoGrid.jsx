                ...
                <div className="space-y-2 lg:space-y-3 py-2">
                  ...
                  <div className="flex flex-row-reverse">
                    ...
                    <div className="bg-[#24242b] p-2 lg:p-3 rounded-lg border border-gray-700 max-w-[80%]">
                      <div className="text-xs lg:text-sm text-white">You can submit your rewards in the employee portal under "My Benefits" → "Rewards". Need help accessing that section?</div>
                    </div>
                  </div>
